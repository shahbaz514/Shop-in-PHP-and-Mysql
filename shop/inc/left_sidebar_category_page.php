...
<div class="filter left-sidebar-widget mb_50">
    ...
    <div class="filter-block">
        <p>
            ...
            <br>
        <form action="category_page.php" enctype="multipart/form-data" method="post">
            <div class="row">
                <div class="col-sm-4">
                    <input type="number" min="0" name="starPrice" placeholder="From" class="form-control">
                </div>
                <div class="col-sm-4">
                    <input type="number" min="0" name="endPrice" placeholder="To" class="form-control">
                </div>
                <div class="col-sm-4">
                    <button type="submit" name="searchPrice" class="btn btn-danger">

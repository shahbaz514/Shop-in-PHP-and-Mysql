                ...
                <div class="row">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <?php
                            $c = $_SESSION['email'];
                            $get_orders = "SELECT * FROM orders_customers WHERE email='".$_SESSION['email']."' AND status = 'Pending'";
                            ...
                            if (mysqli_num_rows($run_orders) > 0) {
                                while ($row = mysqli_fetch_array($run_orders)) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;">
                                            <a class="btn btn-block btn-sm" style="border-radius: 5px;"  href="editStatus.php?invoice=<?php echo $row['orderid']; ?>">

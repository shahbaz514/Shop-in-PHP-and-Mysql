...
$sqlCustomer = mysqli_query($db, "SELECT * FROM `customers` WHERE email = '".$_SESSION['email']."'");
            ...
            <div class="card">
                <div class="card-header bg-transparent header-elements-inline">
                    ...
                    <div class="header-elements">
                        <a type="button" href="userAccount.php" class="btn btn-light btn-sm ml-3"><i class="fa fa-backward mr-2"></i></a>
                ...
                <div id="div_print">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-8">
                                <img src="admin/logo.png" style="text-align: left; float: left; width: 160px; vertical-align: middle;">
                            </div>
                            <div class="col-sm-4">

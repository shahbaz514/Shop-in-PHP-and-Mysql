...
<?php
$sqlQuotation = mysqli_query($db, "SELECT * FROM `orders_admins` WHERE orderid = '".$_GET['invoice']."'");
            ...
            <div class="card">
                <div class="card-header bg-transparent header-elements-inline">
                    ...
                    <div class="header-elements">
                        <a type="button" href="allAdminOrders.php" class="btn btn-light btn-sm ml-3"><i class="fa fa-backward mr-2"></i></a>

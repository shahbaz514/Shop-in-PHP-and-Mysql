                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <label for="email_address">Account Title:*</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="title" placeholder="Account Title" required>
                                </div>
                            </div>
                            <label for="email_address">Account Number:*</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="ac_num" placeholder="Account Number" required>
                                </div>
                            </div>
                            <hr>
                            <button type="submit" class="btn btn-danger m-t-15 waves-effect" name="addCategory">Add New Bank Account</button>
                        </form>
                        <?php
                        if (isset($_POST['addCategory']))
                        {
                            ...
                            if ($sqlAdd)
                            {
                                echo "<script>window.open('allAccounts.php', '_self')</script>";
                            }
                            else
                            {
                                echo '

                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <?php
                                $count = 0;
                                $get_orders = "SELECT * FROM orders_admins ORDER BY id DESC";
                                ...
                                if (mysqli_num_rows($run_orders) > 0) {
                                    while ($row = mysqli_fetch_array($run_orders)) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <a class="btn btn-block btn-danger btn-sm" style="border-radius: 5px;" href="orderDetailAdmins.php?invoice=<?php echo $row['orderid']; ?>">
                                            ...
                                            <td style="vertical-align: middle;">
                                                <a class="btn btn-block btn-danger btn-sm" style="border-radius: 5px;"  href="editStatusAdmin.php?invoice=<?php echo $row['orderid']; ?>">

...
if (isset($_GET['del']))
{
    $sqlProDel = mysqli_query($db, "DELETE FROM `terms` WHERE id = '".$_GET['del']."'");
    if ($sqlProDel)
    {
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                while ($rowPro = mysqli_fetch_array($sqlPro))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center><a style="width:80px;" class="btn btn-block bg-pink waves-effect" href="allTerms.php?del=<?php echo $rowPro['id']; ?>"><i class="material-icons">delete</i></a></center>
                                        </td>
                                    </tr>
                                    <?php
                                }
